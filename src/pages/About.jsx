        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center relative">
            <Reveal className="relative block" direction="right">
              <div className="h-[240px] sm:h-[360px] lg:h-[420px] rounded-tr-[20vw] overflow-hidden lg:transform lg:translate-y-8 lg:z-10">
                <img
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {values.map(({ title, description, icon }, index) => (
              <Reveal
                key={title}
                className="rounded-lg border border-mauve-200 bg-mauve-50 p-8"
                delay={index * 0.08}
              >
                {createElement(icon, {
                  size: 28,
                  className: "mb-2 text-mauve-500",
                })}
                <h3 className="mb-4 font-display text-2xl lg:text-3xl text-mauve-900">
                  {title}
                </h3>
                <p className="font-ui text-base font-light text-mauve-800">
                  {description}
                </p>
              </Reveal>
            ))}
